package hcaudio.ttsdemo;



import hcaudio.common.ConnUtil;
import hcaudio.common.TokenHolder;
...
//    }
    ...
    public  String run(String word0) throws IOException, DemoException {
        String word="";
        ...
        String params = "tex=" + ConnUtil.urlEncode(ConnUtil.urlEncode(word0));
        params += "&per=" + per;
        params += "&spd=" + spd;
        params += "&pit=" + pit;
        params += "&vol=" + vol;
