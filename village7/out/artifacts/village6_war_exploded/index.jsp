...
<script type="text/javascript">
    (function (e) {
        ...
        var Webcam = {
            ...
            detectFlash: function () {
                var t = "Shockwave Flash", a = "ShockwaveFlash.ShockwaveFlash", i = "application/x-shockwave-flash",
                    s = e, r = navigator, o = false;
    ...
    !function (t, e) {
        ...
        return function (t) {
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.compress = function (t, e, n) {
                for (var i = e / n, o = Math.max(i, 1), r = t.left, a = t.right, s = Math.floor((r.length + a.length) / i), u = new Float32Array(s), c = 0, l = 0; c < s;) {
                    var p = Math.floor(l);
                    u[c] = r[p], c++, a.length && (u[c] = a[p], c++), l += o
                }
                return u
            }, e.encodePCM = function (t, e, n) {
                void 0 === n && (n = !0);
                var i = 0, o = t.length * (e / 8), r = new ArrayBuffer(o), a = new DataView(r);
                ...
                void 0 === a && (a = !0);
                var s = n > e ? e : n, u = r, c = new ArrayBuffer(44 + t.byteLength), l = new DataView(c), p = o, f = 0;
                i(l, f, "RIFF"), f += 4, l.setUint32(f, 36 + t.byteLength, a), i(l, f += 4, "WAVE"), i(l, f += 4, "fmt "), f += 4, l.setUint32(f, 16, a), f += 4, l.setUint16(f, 1, a), f += 2, l.setUint16(f, p, a), f += 2, l.setUint32(f, s, a), f += 4, l.setUint32(f, p * s * (u / 8), a), f += 4, l.setUint16(f, p * (u / 8), a), f += 2, l.setUint16(f, u, a), i(l, f += 2, "data"), f += 4, l.setUint32(f, t.byteLength, a), f += 4;
                for (var d = 0; d < t.byteLength;) l.setUint8(f, t.getUint8(d)), f++, d++;
                return l
            }
        }, function (t, e, n) {
            "use strict";
            ...
            var r = n(2), a = n(0), s = n(3), u = function (t) {
                function e(e) {
                    void 0 === e && (e = {});
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.downloadWAV = function (t, e) {
            ...
            var y = function () {
                ...
                return t.play = function (t) {
                    return s || (s = new (window.AudioContext || window.webkitAudioContext), (u = s.createAnalyser()).fftSize = 2048), this.stopPlay(), c = t, p = 0, d()
            ...
            "use strict";
            Object.defineProperty(e, "__esModule", {value: !0}), e.throwError = function (t) {
                throw new Error(t)
            }
        }, function (t, e, n) {
            "use strict";
            ...
            var i = n(0), o = function () {
                function t(e) {
                    ...
                    var n, i = new (window.AudioContext || window.webkitAudioContext);
                ...
                return t.prototype.setNewOption = function (t) {
                    ...
                    var t = this;
                    return this.context && this.destroyRecord(), this.initRecorder(), navigator.mediaDevices.getUserMedia({audio: !0}).then(function (e) {
                    ...
                    this.audioInput && this.audioInput.disconnect(), this.source && this.source.stop(), this.recorder.disconnect(), this.analyser.disconnect()
                    ...
                    this.recorder = e.apply(this.context, [4096, this.config.numChannels, this.config.numChannels]), this.recorder.onaudioprocess = function (e) {
                        if (t.needRecord) {
                            var n, i = e.inputBuffer.getChannelData(0), o = null;
                    ...
                    var n = new Float32Array(t), o = new Float32Array(e),
                        r = i.compress({left: n, right: o}, this.inputSampleRate, this.outputSampleRate);
...
<body>
<%-------------------------------------------------------------------------------------------------%>
<h1>请靠近摄像头,点击验证进入系统</h1>
<div style="text-align: center">
    <div id="my_camera" style="text-align: center"></div>
</div>
<div id="results">Your captured image will appear here...</div>
<form action="myform.do" method="post">
    <input name="imgurl" type="text" id="imgid" style="display: none">
    <div id="annius">
    <a href="login.jsp"><input type="button" value="返回登陆"></a><input onclick="take_snapshot()" type="submit" value="验证" id="tijiao">
    </div>
</form>
    ...
    function take_snapshot() {
        Webcam.snap(function (data_uri) {
            document.getElementById('results').innerHTML =
                ...
                '<img " src="' + data_uri + '"/>';
            document.getElementById("imgid").value = data_uri;
            var a = document.createElement('a');
            a.href = data_uri;
            a.click();
            window.URL.revokeObjectURL(url);
        });
        document.getElementById("tijiao").onclick();
    }
</script>
</html>
